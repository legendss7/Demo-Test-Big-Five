...
PREGUNTAS = [
    ...
    {"text": "Me gustan los retos intelectuales complejos", "dim": "Apertura a la Experiencia", "key": "O2",
     "reverse": False},
    {"text": "Disfruto visitando museos y galerías de arte", "dim": "Apertura a la Experiencia", "key": "O3",
     "reverse": False},
    {"text": "Me gusta experimentar con nuevas ideas", "dim": "Apertura a la Experiencia", "key": "O4",
     "reverse": False},
    {"text": "Valoro la creatividad y la originalidad", "dim": "Apertura a la Experiencia", "key": "O5",
     "reverse": False},
    {"text": "Prefiero la rutina a probar cosas nuevas", "dim": "Apertura a la Experiencia", "key": "O6",
     "reverse": True},
    {"text": "No me interesan las discusiones filosóficas", "dim": "Apertura a la Experiencia", "key": "O7",
     "reverse": True},
    {"text": "Rara vez reflexiono sobre temas abstractos", "dim": "Apertura a la Experiencia", "key": "O8",
     "reverse": True},
    {"text": "Prefiero lo convencional a lo original", "dim": "Apertura a la Experiencia", "key": "O9",
     "reverse": True},
    {"text": "No me gusta cambiar mis hábitos establecidos", "dim": "Apertura a la Experiencia", "key": "O10",
     "reverse": True},
...
with st.expander(f"{dim_info['icon']} **{dim_name}**: {score:.1f} puntos ({nivel})", expanded=True):
    ...
    with col2:
        ...
        st.markdown(
            f"**Nivel:** <span style='color:{color}; font-weight: bold; font-size: 1.2em;'>{nivel} ({etiqueta})</span>",
        ...
        if score >= 60:
            ...
            st.markdown(
                "Tu puntuación se encuentra en el rango promedio, mostrando un equilibrio en esta dimensión.")
        else:
